...
export default function AnimatedStatsCard({
  ...
  const borderColorClass = `border-${color}-200 dark:border-${color}-800`;
  ...
  return (
    <AnimatedContainer 
      ...
      className={className}
    >
      <Card className={`border-2 ${borderColorClass} shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden`}>
        <div className={`absolute inset-0 opacity-30 bg-gradient-to-br from-${color}-50 to-${color}-100 dark:from-${color}-950/40 dark:to-${color}-900/30`} />
